          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">Coupons</h4>
                </div>
                <div>
                    <a href="#"> <button type="button" class="btn btn-primary btn-icon-text btn-rounded">
                      <i class="ti-clipboard btn-icon-prepend"></i>Add Coupons
                    </button></a>
                </div>
              </div>
            </div>
  ...
  <div class="col-12 grid-margin stretch-card">
    ...
    @foreach($coupons as $customer)
        ...
        <td width="45%"><a href="{{ route('customer.view', ['id' => $customer->id ]) }}">
          <strong>Code </strong> {{ $customer->name }} <br>
          <strong>Amount: </strong> {{ $customer->amount }} <br>
