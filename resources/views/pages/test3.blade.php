      ...
      <nav class="navbar-nav nav-light d-md-flex" 
        ...
        <div class="container"> 
            ...
            <a class="p-2 text-light pull-right d-none d-sm-none d-md-inline">
              ...
              <!-- <img  src="{{ asset('img/usd.png')}}" style="height: 15px;"></a>   -->
...
<!-- categories start #2a3447-->
  ...
  <button class="navbar-toggler p-0 border-0 pull-right" type="button" data-toggle="offcanvas">
   ...
   <img class="image-responsive mb-2" src="{{asset('img/online/ban90.png')}}" alt="gem" width="100%">
<!-- LIVE online -->
...
<div id="London" class="tabcontent">
  ...
  <img src="{{ asset('img/online/web2.png')}}" width="340px">
  </div>
  <div class="col-md-8"> 
...
PHP Website Development | Ajax ProgrammingStatic Website
<table class="mt-2">
<tr>
  <td>Basic HTML BS4 CSS website from </th><td> $ 99</td>
</tr>
<tr>
  <td>Standard WordPress website from </th><td> $ 149</td>
</tr>
<tr>
  <td>Standard HTML BS4 CSS website from </th><td> $ 149</td>
</tr>
</table>
