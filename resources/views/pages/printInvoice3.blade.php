...
<div class="content">
    <!-- Begin page content -->
    <div class="invoice-print m-3"> 
              <p>   <a href="#"  onClick="printPDF()"><i class="fa fa-print"></i> Print</a>
              </p>
...
<!-- <hr style="border-color: #c2c2c2;"> -->
  ...
  <footer class="footer text-center">
       <div class="container mt-0">
        <span class="text-muted">Gates Tech Online | 1 Bucks New Town, Buckinghamshire, UK | gatestechonline@gmail.com</span>
      </div>
