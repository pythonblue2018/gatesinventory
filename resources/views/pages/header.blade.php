...
<nav class="navbar navbar-expand-md navbar-light bg-default">
      <a class="navbar-brand" href="/shopHome">
          <img src="{{ asset('img/gatestech.png')}}" height="70px"/>
      </a>
...
<li class="nav-item btn-group"  id="dropdown" style="
                  background: #b2b2b2; width: 270px;border-radius: 0px;">
            <a class="nav-link js-scroll-trigger dropdown-toggle ml-2" data-toggle="dropdown" href="#" style="color: white;width: 250px;">Categories
               <i class="fa fa-bars p-1 pull-right"></i>
             </a>
              ...
              <li class="dropdown-item mt-0" style="border-bottom: 1px solid #dadada; padding: 10px 20px;">
                {{ $product->name }} 
                 <!-- <i class="fa fa-lg fa-blender pull-right"></i> -->
                  </li>
                </a>

                    @endforeach
                  <a href="{% url 'shop:products' %}">
                  <li class="dropdown-item p-3" style="border-bottom: 1px solid #dadada;" >
                      View All
