...
<div class="row">
<div class="col-md-12">
<input type="hidden" name="_token" value="avNjHNjThSttfQ2Gqs57sze8ek">            
...
<div class="form-row">
    ...
    {{ csrf_field() }}
    <button type="submit" class="btn btn-success text-center" style="cursor: pointer; padding:10px 30px; margin-left: 20px;"><i class="fa fa-check"></i>
    Pay Now</button>
</td></tr>
</tr>
</table>
...
<tr class="discount">
<th>Discount / Coupon ({{ isset($coupon) ? $coupon : 0 }})</th>
<td style="text-align: right" id="subtotal">$ {{ isset($coupon_amount) ? $coupon_amount :0 }}</td>
</tr>
<tr class="shippingCost">
<th>Shipping Cost ( Shipping Method )</th>
    @php $shippingCost = (isset($shipping)) ? $shipping : 0 @endphp
<td style="text-align: right" id="shippingCost">$ {{ $shippingCost }}</td>
</tr>

<tr class="showTotal" style="background:#f5f3f3;font-weight: bold;">
<th>Total</th>
<td style="text-align: right" id="total">$ {{ $totalprice + $shippingCost - (isset($coupon_amount) ? $coupon_amount :0) }}</td>
</tr>
...
<div class="row" style="display: table-row;">        
 ...
 <p><div class ="shipping_radio">
      <input type="radio" name="shipping_radio"  id="question1" value="0"> <label for="Free Shipping ($0.00)"> Free Shipping ($0.00)</label><br>
      <input type="radio" name="shipping_radio"  id="question1" value="10"> <label for="question1"> Standard Shipping ($10.00)</label><br>
      <input type="radio" name="shipping_radio"  id="question1" value="20"> <label for="question1"> Express Shipping ($20.00)</label> 
   </div></p>
 @endif 
</form>
