...
<div class="container">
    ...
    <!-- Invoice Company Details -->
     <div class="col-md-12 text-center mt-4">
      <!--  <p class="pull-right"><small><a href="#"class="btnprint" ><i class="fa fa-print"></i> Print</a>
        <i onClick="printPDF()" class="fa fa-print" ></i></small></p> -->
            <h3>Invoice</h3>
      ...
      <p class="pb-1"> INVOICE NUMBER # {{$order->id }} </p>
...
<hr>
      ...
      <p><span class="text-muted">Invoice Date  :</span> {{$order->created_at}}</p> <p><span class="text-muted">Inv Due Date :</span> {{$order->created_at}}</p>  <p><span class="text-muted">Terms :</span> Payment Receipt</p>                    
      </div>
      </div>
    </div>
      <!--/ Invoice Customer Details -->
...
<script type="text/javascript">
  $(document).ready( function () {
    console.log('onload invoice-print');
    printPDF();
  });
