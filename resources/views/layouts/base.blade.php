...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{ route('dashboard.home')}}" class="logo">
      ...
      <span class="logo-mini"><b><img src="{{ asset('dist/img/glogo.jpg')}}" class="img-circle" alt="User Image">Euro</b>Admin</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="{{ asset('dist/img/glogo.jpg')}}" class="img-circle" alt="User Image"><b>Euro</b>Admin</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            @else
            <img src="{{ asset('dist/img/guest.jpg')}}" class="user-image" alt="User Image">
              <span class="hidden-xs"> 
                Guest User
            @endif
           </span>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('admin.userRoles')}}"><i class="fa fa-ban"></i> Permissions</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{ route('shop.products') }}"><i class="fa fa-circle-o"></i> Shop </a></li>
            <li><a href="{{ route('admin.addNewProduct') }}"><i class="fa fa-circle-o"></i> Add New Product</a></li>
            <li><a href="{{ route('admin.addNewProduct') }}"><i class="fa fa-circle-o"></i> Product Attribute</a></li>
          </ul>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.orders') }}"><i class="fa fa-list-ul"></i> Orders</a></li>
            <li><a href="{{ route('admin.createOrder') }}"><i class="fa fa-circle-o"></i> Create Order</a></li>
          </ul>
        </li>
        <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('admin.customers') }}"><i class="fa fa-circle-o"></i> customers</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/shop"><i class="fa fa-circle-o"></i> Shop </a></li>
            <li><a href="pages/charts/flot.html"><i class="fa fa-circle-o"></i> Flot</a></li>
            <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i> Inline charts</a></li>
          </ul>
        </li>
